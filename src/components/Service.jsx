...
const Service = () => {
  return (
    <div>
       ...
       <div className='text-black relative z-20 lg:mt-10 mt-4 space-y-4 mx-3 lg:mx-0 '>
         <div className='bg-gray-50 bg-opacity-5 shadow p-4 rounded-xl space-y-2'>
              <h1 className='text-2xl font-semibold text-sky-900 drop-shadow'>Our Service</h1>
            ...
            <div className='grid lg:grid-cols-3 lg:gap-6 gap-2'>
                  ...
                  <p className='opacity-65 text-sm px-3 py-4 shadow-inner'>We create unique and memorable logos that represent your brand's identity. Our designers work with you to bring your vision to life.</p>
                  </div>
                  ...
                  <p className='opacity-65 text-sm px-3 py-4 shadow-inner'>We build custom websites that are attractive, easy to use, and optimized for search engines. Our websites help you connect with your customers and grow your business.</p>
                  </div>
                  ...
                  <p className='opacity-65 text-sm px-3 py-4 shadow-inner'>We design user-friendly and visually appealing websites that provide a seamless experience. Our focus ensures that your visitors have an engaging and interaction with your site.</p>
                  </div>
            </div>

            <div className='lg:grid grid-cols-2 hidden gap-6'>
              
              <div className='bg-gray-50 bg-opacity-5 shadow p-4 rounded-xl flex items-center justify-center'>
