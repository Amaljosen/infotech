  ...
  return (
    <div>
       ...
       <div className='text-black relative z-20 lg:mt-10 mt-2 lg:space-y-4 space-y-2 mx-3 lg:mx-0' >
         <motion.div className='bg-gray-50 bg-opacity-5 shadow-md p-4 rounded-xl space-y-2 ' initial={{ opacity: 0 ,y:-80}} animate={active ==='/service' ? { opacity: 1,y:0 } : {}} transition={{ duration: 0.6 }}>
            ...
            <div className='grid lg:grid-cols-3 lg:gap-6 gap-2'>
                  <motion.div className='bg-gray-50 bg-opacity-5 shadow rounded-xl overflow-hidden' initial={{ opacity: 0 ,x:-120}} animate={active ==='/service' ? { opacity: 1,x:0 } : {}} transition={{ duration: 0.7 }}>
                  ...
                  <motion.div className='bg-gray-50 bg-opacity-5 shadow rounded-xl overflow-hidden' initial={{ opacity: 0 }} animate={active ==='/service' ? { opacity: 1, } : {}} transition={{ duration: 0.7 }}>
            ...
            <motion.div className='lg:grid grid-cols-2 hidden gap-6' initial={{ opacity: 0,y:100 }} animate={active ==='/service' ? { opacity: 1,y:0 } : {}} transition={{ duration: 0.6 }}>
